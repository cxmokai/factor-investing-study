...
> 今天学前两张（资产负债表 + 利润表），Day 04 学现金流量表和综合分析。

#### 1.3 和因子投资的关系

Day 01 提到过 PE 和 PB，当时只给了直觉。现在可以揭示它们的来源了：
...
> PB 低可能是真便宜，也可能是"便宜有便宜的道理"——这就是 Day 01 说的**"价值陷阱"**。
...
> 这就是为什么需要**现金流量表**（Day 04 学）——利润表告诉你"账面上赚了多少"，
> 现金流量表告诉你"真金白银进出了多少"。
...
> Day 01 说过："PE 看赚钱能力贵不贵，PB 看家底贵不贵。"
...
> - **NVT（网络价值/交易量比）** ≈ PE——Day 01 §2.6 已经介绍过
...
| PS（市销率） | 知道存在，用于没盈利的公司 | Day 04 会再提 |
| ROE 的杜邦分解 | 今天不需要 | Day 04 综合分析 |
| 现金流量表 | 知道"利润不等于现金"的原因 | Day 04 详细讲 |
