...
Day 03 讲到一个关键结论：**利润高不等于现金多。** 当时举了三个例子：
...
Day 03 的比喻：现金流量表 = 你银行卡的流水账单。利润表告诉你"理论上赚了多少"，现金流量表告诉你"银行卡里实际多了/少了多少钱"。
...
$$\text{FCF 收益率} = \frac{\text{自由现金流}}{\text{市值}}$$
...
Day 03 + Day 04 学完三张表后，来看它们之间的关系：
...
Day 03 介绍了 ROE 的公式：ROE = 净利润 / 净资产。今天要回答一个更深的问题：**ROE 高就一定好吗？**
...
$$\text{ROE} = \frac{\text{净利润}}{\text{净资产}} = \frac{\text{净利润}}{\text{营收}} \times \frac{\text{营收}}{\text{总资产}} \times \frac{\text{总资产}}{\text{净资产}} = \text{净利率} \times \text{资产周转率} \times \text{权益乘数}$$
...
| 组成部分 | 公式 | 衡量什么 | 类比 |
|---------|------|---------|------|
| **净利率** | $\frac{\text{净利润}}{\text{营收}}$ | 每赚 100 块有多少变成利润 | 卖东西的利润有多"厚" |
| **资产周转率** | $\frac{\text{营收}}{\text{总资产}}$ | 资产一年能创造多少收入 | 资产"转"得有多"快" |
| **权益乘数** | $\frac{\text{总资产}}{\text{净资产}}$ | 用了多大的杠杆 | 借了多少倍的钱 |
...
Day 03 已经学了 PE、PB、EPS、ROE 的公式和含义。今天补充两个新指标，然后做一个完整总结。
...
| 指标 | 公式 | 含义 |
|------|------|------|
| **股息率** | $\frac{\text{每股股息}}{\text{股价}}$ | 投资者角度：我投入的钱每年能拿多少分红 |
| **分红率** | $\frac{\text{股息总额}}{\text{净利润}}$ | 公司角度：赚的钱分出去了多少 |
...
$$\text{PS} = \frac{\text{股价}}{\text{每股营收}} = \frac{\text{市值}}{\text{营收}}$$

Day 03 末尾提到"PS 用于还没盈利的公司"。今天展开说明：
...
把 Day 03 和 Day 04 学的所有指标整合到一张表里：

| 指标 | 全称 | 公式 | 数据来源 | 衡量什么 | 因子投资用途 |
|------|------|------|---------|---------|------------|
| **PE** | Price-to-Earnings | $\frac{\text{股价}}{\text{EPS}}$ | 利润表 | 赚钱能力贵不贵 | 价值因子 |
| **PB** | Price-to-Book | $\frac{\text{股价}}{\text{每股净资产}}$ | 资产负债表 | 家底贵不贵 | 价值因子 |
| **PS** | Price-to-Sales | $\frac{\text{市值}}{\text{营收}}$ | 利润表（营收行） | 收入贵不贵 | 辅助指标 |
| **EPS** | Earnings Per Share | $\frac{\text{净利润}}{\text{总股数}}$ | 利润表 | 每股赚多少 | PE 的分母 |
| **ROE** | Return On Equity | $\frac{\text{净利润}}{\text{净资产}}$ | 利润表 + 资产负债表 | 赚钱效率 | 质量因子（核心） |
| **毛利率** | Gross Margin | $\frac{\text{毛利润}}{\text{营收}}$ | 利润表 | 产品赚钱能力 | 质量因子 |
| **股息率** | Dividend Yield | $\frac{\text{每股股息}}{\text{股价}}$ | 分红数据 + 股价 | 分红回报率 | 红利因子 |
| **FCF Yield** | FCF Yield | $\frac{\text{FCF}}{\text{市值}}$ | 现金流量表 | 现金回报率 | 价值因子（替代） |
...
> **加密资产的"财务指标"类比：**
> 虽然加密货币没有传统三张表，但某些概念有直接对应：
> - **ETH 质押收益率（~3-4%）** ≈ 股息率——持有 ETH 并质押可获得稳定收益
> - **EIP-1559 的 ETH 销毁机制** ≈ 股票回购——每笔交易销毁一部分 ETH，减少总供给，间接提升每个 ETH 的价值
> - **DeFi 协议的手续费收入** ≈ 经营现金流——Uniswap 的交易手续费、Aave 的借贷利差，都是协议"赚到的真金白银"
> - **FCF Yield 的类比：** 协议收入/市值 = 协议的"自由现金流收益率"，可用来横向比较不同 DeFi 协议的"性价比"
>
> 和 Day 03 介绍的链上数据指标结合，你已经有了分析加密资产的基本工具箱。
...
- [ ] 能画出三张表之间的联系
- [x] 知道杜邦公式：ROE = 净利率 × 资产周转率 × 权益乘数
- [x] 能说出高 ROE 的三种来源（高利润率、高周转、高杠杆）
- [x] 理解 ROE 高不一定好——关键看杠杆是否过高
- [x] 知道股息率和分红率的区别
- [x] 知道 PS 的含义和适用场景
- [ ] 能用完整指标体系对一家公司做"财务体检"
- [x] 理解质量因子和价值因子为什么往往矛盾
...
**7-8 道对：** 不错，回看错的部分就好。
**6 道以下：** 建议花 20 分钟回顾 Day 03 + Day 04 讲义。
...
> 至此，模块二（财务报表与估值指标）全部完成。你已经掌握了因子投资中价值因子、质量因子、红利因子所需的全部财务知识"原材料"。从 Day 05 开始，进入收益与风险度量——学习评估因子策略表现的工具。

---

## 明天预告

**Day 05** 进入新模块——**收益与风险度量**。
...
> 从 Day 05 开始，数学会逐渐增多。不用害怕——都是高中水平的数学，而且每个公式都会用具体例子讲透。
