...
Day 08-10 建立了因子投资的完整框架：CAPM → 三因子 → 五因子 + 动量。你已经知道"有哪些因子""怎么构造因子组合"。
...
Day 09 提到了两种解释——"风险补偿"和"行为偏差"。今天深入讲第二种：**行为金融学（Behavioral Finance）**。
...
Meme 币把羊群效应展现到了极致——它们几乎没有任何基本面，价格完全由社交情绪驱动：

| Meme 币 | 触发因素 | 羊群机制 | 结果 |
|---------|---------|---------|------|
| **DOGE** | Elon Musk 连续发推 | 粉丝跟风买入 → 价格暴涨 → 媒体报道 → 更多人涌入 | 2021 年涨超 100 倍，之后跌去 90%+ |
| **SHIB** | "下一个 DOGE"叙事 | DOGE 涨了 → "便宜的类似币也会涨" → 从众买入 | 同样暴涨暴跌 |
| **PEPE** | Twitter/Telegram 社群炒作 | 社群喊单 → FOMO 买入 → 暴涨引发更多 FOMO | 数天内百倍，数周内归零附近 |

加密社群（Twitter/Telegram/Discord）是羊群效应的**加速器**：

- 信息传播极快（一条推文可以在几分钟内触发数十亿美元的资金流动）
- 社群封闭形成**回音室**——群里所有人都在喊"买买买"，你很难保持理性
- **FOMO 循环：** 社交媒体炒作 → 价格飙升 → 更多炒作 → 更多买入 → 直到最后一个接盘者入场 → 崩盘
...
这是今天最重要的内容——把第一节学的行为偏差和 Day 08-10 学的因子一一对应。
...
加密市场拥有让行为偏差**更极端**的一切条件：

| 条件 | 为什么放大偏差 |
|------|-------------|
| **24/7 交易，无休市** | 没有冷静期——恐慌时凌晨 3 点也能割肉，FOMO 时周末也能追涨 |
| **散户主导** | 机构占比低，"聪明钱"的纠错力量弱——错误定价持续更久 |
| **社交媒体回音室** | Twitter/Telegram 群的信息高度同质——所有人都在喊同一个方向 |
| **极端波动** | 日涨跌 20%+ 不罕见——触发损失厌恶和恐慌的频率远高于股票市场 |
| **缺乏基本面锚定** | 大多数代币没有现金流、没有利润——价格缺少"合理值"参照，完全靠叙事驱动 |

**加密案例 × 行为偏差对照表：**

| 行为偏差 | 加密市场真实案例 |
|---------|---------------|
| **过度反应** | LUNA/UST 崩盘（2022.5）：$400 亿市值在 3 天内归零。恐慌不仅摧毁了 LUNA，还蔓延到完全无关的优质项目——BTC 和 ETH 也被恐慌性抛售 |
| **反应不足** | BTC 现货 ETF 获批（2024.1）：重大利好，但价格不是一步到位暴涨，而是在之后的数月中缓慢上涨——市场对这个明确的好消息消化得出奇地慢 |
| **损失厌恶** | "Diamond Hands" / HODL 文化：持有者亏损 50% 后拒绝卖出（"不卖就不算亏"），本质是损失厌恶的极端表现 |
| **锚定效应** | BTC 前高 $69,000（2021.11）作为强锚定点——此后两年，每次价格接近这个数字，大量投资者选择"回本就卖" |
| **代表性偏差** | "这个山寨币就是下一个 ETH"——基于表面相似性（同为智能合约平台）做出投资判断，忽略了成功概率极低的统计事实 |

> **对因子投资的启示：**
> 行为偏差更强 → 错误定价更多 → 因子溢价可能更大。加密市场中动量因子的月度溢价可达 15-20%（Day 09 §9.2 提到的数据），远超传统市场的 1-2%。
>
> **但硬币的另一面：** 因子失效时的回撤也更极端。传统市场中价值因子的最大回撤可能是 -30%，在加密市场中类似策略的回撤可能达到 -70% 甚至更多。更高的潜在收益对应更高的潜在痛苦——你需要想清楚自己能承受多少。
...
Day 09 提过因子溢价有两种解释。学完行为金融后，可以给出更完整的判断：
...
```mermaid
graph TD
    A["Day 01-02<br>市场基础<br>知道交易什么<br>成本多少"] --> B["Day 03-04<br>财务报表<br>PE/PB/ROE<br>因子数据来源"]
    B --> C["Day 05<br>风险与收益<br>波动率/夏普<br>评估工具"]
    C --> D["Day 06-07<br>投资组合理论<br>分散化/有效前沿<br>组合方法"]
    D --> E["Day 08<br>CAPM<br>Beta/Alpha<br>因子投资起点"]
    E --> F["Day 09<br>三因子模型<br>SMB/HML<br>因子投资基石"]
...
| 层次 | 问题 | 回答 | 对应天数 |
|:----:|------|------|:-------:|
| **是什么** | 因子投资是什么？有哪些因子？ | 系统性地构造因子组合获取溢价。六大经典因子 | Day 08-10 |
| **怎么做** | 因子怎么构造？怎么组合？怎么评估？ | 做多-做空构造法、多因子组合、夏普/回撤评估 | Day 05-07, 10 |
...
自测 10：11 天金融基础回答了关于因子投资的哪三个层次的问题？
→ 你的答案：_______________
→ 正确：(1) 是什么——因子投资的定义和六大因子（Day 08-10）；
  (2) 怎么做——因子构造、组合、评估方法（Day 05-07, 10）；
  (3) 为什么——因子溢价为什么存在和持续（Day 11）。
```

**9-10 道对：** 完美，金融基础部分圆满完成。
**7-8 道对：** 不错，回看错的部分就好。
...
> 金融基础 11 天至此全部完成。你已经建立了因子投资的完整认知框架：知道"是什么"（六大因子）、"怎么做"（构造、组合、评估）、"为什么"（行为偏差 + 风险补偿 + 套利限制）。接下来进入数学基础、因子投资和编程实战阶段——把这些理论变成可以运行的代码、可以赚钱的策略。
...
现在你知道了：
- 资产的收益来自承担风险（Day 05-08）
- 风险不止市场一种——还有市值、价值、动量、盈利、投资（Day 09-10）
- 系统性地构造因子组合，可以获取这些风险溢价（Day 10）
- 因子溢价之所以存在且持续，是因为人类大脑的固有偏差（Day 11）

接下来的路：
- **数学基础（Day 12-21，10 天）**：线性代数、概率统计、时间序列——让你能"算"
