...
| **新股上市首日** | 不设涨跌停（科创板/创业板） | 但有临时停牌机制 |

**例子：** 一只股票昨天收盘价 100 元，今天最多涨到 110 元（涨停）或跌到 90 元（跌停）。
...
graph TD
    ...
    C --> D["每月成本<br>≈ 0.15%"]
    D --> E["一年 12 次调仓<br>总成本 ≈ 1.8%"]
    E --> F["如果策略年化超额收益只有 3%<br>交易成本就吃掉了 60%！"]
```
...
- [ ] 知道一笔交易从下单到成交的流程
- [ ] 知道 A 股交易时间（9:30-11:30, 13:00-15:00）
- [ ] 知道 T+1 是什么意思
- [ ] 知道涨跌停幅度（主板 ±10%，创业板/科创板 ±20%）
- [ ] 知道 A 股最小交易单位是 100 股
- [ ] 知道限价单和市价单的区别
- [ ] 能算出一笔交易的总成本（佣金 + 印花税 + 过户费）
- [ ] 理解交易成本对因子策略的影响
...
> 比如你回测 2020-2024 年"市值最小的 50 个币"，但很多小币已经归零消失了，
> 你的数据集里只剩下"活下来的"，结果看起来比实际好很多。
> A 股也有这个问题（退市股），但加密市场更严重。

---

### 第二节完成检查

- [ ] 知道 CEX 和 DEX 的区别，因子投资主要用 CEX
- [ ] 知道什么是交易对（如 BTC/USDT）和稳定币
- [ ] 知道加密市场 24/7、T+0、无涨跌停
- [ ] 知道 Maker / Taker 费用模型
- [ ] 能算出一笔加密交易的总成本
- [ ] 能说出 A 股和加密市场至少 5 个关键差异
- [ ] 理解生存偏差对因子投资的影响
