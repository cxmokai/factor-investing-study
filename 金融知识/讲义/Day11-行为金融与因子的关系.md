...
> 金融知识 11 天至此全部完成。你已经建立了因子投资的完整认知框架：知道"是什么"（六大因子）、"怎么做"（构造、组合、评估）、"为什么"（行为偏差 + 风险补偿 + 套利限制）。接下来进入数学知识、因子投资和编程实战阶段——把这些理论变成可以运行的代码、可以赚钱的策略。
...
接下来的路：
- **数学知识（Day 12-21，10 天）**：线性代数、概率统计、时间序列——让你能"算"
